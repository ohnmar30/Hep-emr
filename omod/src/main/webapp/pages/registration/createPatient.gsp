...
<div class="ke-page-content">
	...
	<script type="text/javascript">
		...
		function ke_useNewPerson() {
			ui.navigate('chaiemr', 'registration/createPatient2');
		}

		function ke_useExistingPerson() {
			ui.navigate('chaiemr', 'registration/createPatient1');
		}
			...
			<tr>
				<td style="width: 50%; text-align: left; vertical-align: middle">
					<button type="button" onclick="ke_useNewPerson()">
						<img src="${ ui.resourceLink("chaiui", "images/buttons/account_add.png") }" /> Register new Patient
					</button>
				</td>
				<td style="width: 50%; text-align: right; vertical-align: middle">
					<button type="button" onclick="ke_useExistingPerson()">
						<img src="${ ui.resourceLink("chaiui", "images/buttons/account_add.png") }" /> Register Existing User to Patient
					</button>
				</td>
