...
public class EmrOpenmrsUrlOverrideControllerTest {
	...
	public void showOurHomepage() {
		...
		Assert.assertThat(controller.showOurHomePage(), is("forward:/chaiemr/home.page"));
	}
	...
	public void showLoginHomepage() {
		PowerMockito.when(Context.isAuthenticated()).thenReturn(false);
		Assert.assertThat(controller.showOurLoginPage(), is("forward:/chaiemr/login.page"));
	...
	public void showOurForgotPasswordPage() {
		PowerMockito.when(Context.isAuthenticated()).thenReturn(false);
		Assert.assertThat(controller.showOurForgotPasswordPage(), is("forward:/chaiemr/forgotPassword.page"));
