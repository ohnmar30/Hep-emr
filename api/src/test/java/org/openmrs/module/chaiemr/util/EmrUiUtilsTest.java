...
public class EmrUiUtilsTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see EmrUiUtils#formatDrug(org.openmrs.module.chaiemr.regimen.DrugReference, org.openmrs.ui.framework.UiUtils)
	...
	public void formatDrug_shouldFormatDrugReferenceAsConceptOrDrug() throws Exception {
		...
		Assert.assertThat(chaiUi.formatDrug(drugRef1, ui), is(notNullValue()));

		// Test concept only reference
		DrugReference drugRef2 = DrugReference.fromDrugUuid("a74fefc6-931d-47b9-b282-5d6c8c8d8060"); // Rifampicin (100mg)
		Assert.assertThat(chaiUi.formatDrug(drugRef2, ui), is(notNullValue()));
	}

	/**
	 * @see EmrUiUtils#formatRegimenShort(org.openmrs.module.chaiemr.regimen.RegimenOrder, org.openmrs.ui.framework.UiUtils)
	...
	public void formatRegimenShort_shouldFormatRegimen() throws Exception {
		...
		Assert.assertThat(chaiUi.formatRegimenShort(empty, ui), is("Empty"));

		// Check regular regimen
		Assert.assertThat(chaiUi.formatRegimenShort(regimen, ui), is("DAPSONE, STAVUDINE"));
	}

	/**
	 * @see EmrUiUtils#formatRegimenLong(org.openmrs.module.chaiemr.regimen.RegimenOrder, org.openmrs.ui.framework.UiUtils)
	 */
	@Test
	public void formatRegimenLong() {
		// Check empty regimen
		RegimenOrder empty = new RegimenOrder(new HashSet<DrugOrder>());
		Assert.assertThat(chaiUi.formatRegimenLong(empty, ui), is("Empty"));

		// Check regular regimen
		Assert.assertThat(chaiUi.formatRegimenLong(regimen, ui), is("DAPSONE 100mg OD + d4T 30ml BD"));
	}

	/**
	 * @see EmrUiUtils#simpleRegimen(org.openmrs.module.chaiemr.regimen.RegimenOrder, org.openmrs.ui.framework.UiUtils)
	 */
	@Test
	public void simpleRegimen_shouldConvertToSimpleObject() {
		// Check null regimen
		SimpleObject obj1 = chaiUi.simpleRegimen(null, ui);
	...
	public void simpleRegimenDefinitions_shouldConvertToSimpleObjects() throws IOException, SAXException, ParserConfigurationException {
		List<SimpleObject> objs = chaiUi.simpleRegimenDefinitions(regimenManager.getRegimenGroups("category1").get(0).getRegimens(), ui);
