...
public class EmrOpenmrsUrlOverrideController {
	...
	private static final String chaiEMR_HOME_URL = EmrConstants.MODULE_ID + "/home.page";
	private static final String chaiEMR_LOGIN_URL = EmrConstants.MODULE_ID + "/login.page";
	private static final String chaiEMR_FORGOTPASSWORD_URL = EmrConstants.MODULE_ID + "/forgotPassword.page";
	...
	public String showOurHomePage() {
		return Context.isAuthenticated() ? ("forward:/" + chaiEMR_HOME_URL) : ("redirect:/" + OPENMRS_LOGIN_URL);
	}
	...
	public String showOurLoginPage() {
		return Context.isAuthenticated() ? ("redirect:/" + OPENMRS_HOME_URL) : ("forward:/" + chaiEMR_LOGIN_URL);
	}
	...
	public String showOurForgotPasswordPage() {
		return Context.isAuthenticated() ? ("redirect:/" + OPENMRS_HOME_URL) : ("forward:/" + chaiEMR_FORGOTPASSWORD_URL);
	}
}