...
public class EditProgramFormPageControllerTest extends BaseModuleWebContextSensitiveTest {
	...
	public void controller() {
		...
		Assert.assertThat(result, is("redirect:chaiemr/enterForm.page?formUuid=7efa0ee0-6617-4cd7-8310-9f95dfee7a82&appId=test.app&patientId=7&returnUrl=test.html"));
