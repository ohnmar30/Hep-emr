...
package org.openmrs.module.chaiemr.chore;
...
public class FixMissingOpenmrsIdentifiers extends AbstractChore {
	...
	/**
	 * @see org.openmrs.module.chaicore.chore.AbstractChore#perform(java.io.PrintWriter)
	 */
	@Override
	public void perform(PrintWriter output) {
		Location defaultLocation = chaiEmrService.getDefaultLocation();
		...
		for (Patient patient : allPatients) {
			...
			// Every patient needs one preferred ID although we don't use this in ChaiEMR
