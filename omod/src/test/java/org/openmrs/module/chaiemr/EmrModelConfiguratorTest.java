...
public class EmrModelConfiguratorTest extends BaseModuleWebContextSensitiveTest {
	...
	public void setup() {
		...
		PageRequest pageRequest = new PageRequest("chaiemr", "test", request, response, null);
	...
	public void configureModel_page_shouldIncludeNullsForNoParams() {
		...
		Assert.assertThat(pageContext.getModel(), hasEntry("chaiEmrUi", (Object) chaiEmrUi));
	}
	...
	public void configureModel_fragment() {
		FragmentRequest fragRequest = new FragmentRequest("chaiemr", "test");
		FragmentContext fragContext = new FragmentContext(fragRequest, pageContext);

		configurator.configureModel(fragContext);

		Assert.assertThat(fragContext.getModel(), hasEntry("chaiEmrUi", (Object) chaiEmrUi));
	}
