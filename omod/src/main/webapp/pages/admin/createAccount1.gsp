<%
	...
	def menuItems = [
			[ label: "Back to home", iconProvider: "chaiui", icon: "buttons/back.png", label: "Back to accounts", href: ui.pageLink("chaiemr", "admin/manageAccounts") ]
	]
%>
...
<div class="ke-page-content">
	...
	<script type="text/javascript">
		function ke_useNewPerson() {
			ui.navigate('chaiemr', 'admin/createAccount2');
		}
	</script>
				...
				<tr>
					...
					<td style="width: 50%; text-align: right; vertical-align: middle">
						<button type="button" onclick="ke_useNewPerson()">
							<img src="${ ui.resourceLink("chaiui", "images/buttons/account_add.png") }" /> Use new person
						</button>
					</td>
				</tr>
			</table>
		</div>
		<div class="ke-panel-content" ng-controller="PatientSearchResults" ng-init="init('${ currentApp.id }', 'chaiemr', 'admin/createAccount2')">
