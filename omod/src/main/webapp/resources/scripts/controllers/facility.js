 ...
 * Facility service
 */
chaiemrApp.service('FacilityService', function ($rootScope) {
 ...
 */
chaiemrApp.controller('FacilitySearchForm', ['$scope', 'FacilityService', function($scope, facilityService) {
 ...
 */
chaiemrApp.controller('FacilitySearchResults', ['$scope', '$http', function($scope, $http) {
	...
	$scope.refresh = function() {
		if ($scope.query.length >= 3) {
			$http.get(ui.fragmentActionLink('chaiemr', 'search', 'locations', { q: $scope.query })).
