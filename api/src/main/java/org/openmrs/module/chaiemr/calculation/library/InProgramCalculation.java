...
public class InProgramCalculation extends AbstractPatientCalculation {
	...
	/**
	 * @see org.openmrs.module.chaiemr.calculation.BaseEmrCalculation#evaluate(java.util.Collection, java.util.Map, org.openmrs.calculation.patient.PatientCalculationContext)
	 */
	@Override
