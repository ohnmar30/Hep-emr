	...
	<table>
		<tbody>
			<tr style="max-width:100%;overflow:auto;"'>
				...
				<td class="colC" style="text-align:center"><input type="text" ng-model="noOfTablet" id={{choice.noOfTablet}} name={{choice.noOfTablet}} ng-change="usageChange(choice.drugKey)"></td>
