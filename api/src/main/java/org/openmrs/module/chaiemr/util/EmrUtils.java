...
public class EmrUtils {
	...
	private static Logger logger = Logger.getLogger(EmrUtils.class);
	...
	public static Integer msm(Concept c){
		return 0;
	}
	...
	/**
	 * Unlike in OpenMRS core, a user can only be one provider in ChaiEMR
	 * 
	 * @param user
	 *            the user
