...
<script type="text/javascript">
	function showCohortDialog(dataset, column) {
		var contentUrl = ui.pageLink('chaiemr', 'dialog/cohortDialog', { appId: '${ currentApp.id }', request: '${ reportRequest.id }', dataset: dataset, column: column });

		chaiui.openDynamicDialog({ heading: 'View Cohort', url: contentUrl, width: 90, height: 90, scrolling: true });
	}
</script>
...
<div class="ke-panel-content">
	...
	<fieldset>
		...
		${ ui.includeFragment("chaiui", "widget/dataPoint", [ label: it.label, value: reportData.context.parameterValues[it.name] ]) }
		<% } %>
	</fieldset>
	<%
