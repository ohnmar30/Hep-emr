...
package org.openmrs.module.chaiemr.reporting.builder.rdqa;
...
import org.openmrs.module.chaicore.report.builder.AbstractHybridReportBuilder;
...
import org.openmrs.module.chaiemr.calculation.library.hiv.art.CurrentArtRegimenCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.InitialArtStartDateCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.TransferInDateCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.TransferOutDateCalculation;
import org.openmrs.module.chaiemr.calculation.library.rdqa.DateOfDeathCalculation;
import org.openmrs.module.chaiemr.calculation.library.rdqa.DateOfLastCTXCalculation;
import org.openmrs.module.chaiemr.calculation.library.rdqa.PatientCheckOutStatusCalculation;
import org.openmrs.module.chaiemr.calculation.library.rdqa.PatientProgramEnrollmentCalculation;
import org.openmrs.module.chaiemr.calculation.library.rdqa.ValueAtDateOfOtherPatientCalculationCalculation;
import org.openmrs.module.chaiemr.calculation.library.rdqa.VisitsForAPatientCalculation;
import org.openmrs.module.chaiemr.calculation.library.rdqa.WeightAtArtStartDateCalculation;
import org.openmrs.module.chaiemr.metadata.CommonMetadata;
import org.openmrs.module.chaiemr.metadata.HivMetadata;
import org.openmrs.module.chaiemr.reporting.calculation.converter.CustomDateConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.DateArtStartDateConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.EncounterDatetimeConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.GenderConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.ObsDatetimeConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.ObsValueDatetimeConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.ObsValueNumericConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.PatientEntryPointDataConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.PatientProgramEnrollmentConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.PatientProgramEnrollmentDateConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.RDQACalculationResultConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.RegimenConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.WHOStageDataConverter;
import org.openmrs.module.chaiemr.reporting.calculation.converter.WeightConverter;
import org.openmrs.module.chaiemr.reporting.cohort.definition.RDQACohortDefinition;
...
@Component
@Builds({"chaiemr.common.report.rdqaReport"})
public class RDQAReportBuilder extends AbstractHybridReportBuilder {
	public static final String DATE_FORMAT = "dd/MM/yyyy";

	/**
	 *
	 * @see org.openmrs.module.chaicore.report.builder.AbstractCohortReportBuilder#addColumns(org.openmrs.module.chaicore.report.CohortReportDescriptor, org.openmrs.module.reporting.dataset.definition.PatientDataSetDefinition)
	 */
	@Override
