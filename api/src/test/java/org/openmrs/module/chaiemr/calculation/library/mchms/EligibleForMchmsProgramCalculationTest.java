...
public class EligibleForMchmsProgramCalculationTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.chaiemr.calculation.library.mchms.EligibleForMchmsProgramCalculation#evaluate(java.util.Collection, java.util.Map, org.openmrs.calculation.patient.PatientCalculationContext)
	 */
	@Test
