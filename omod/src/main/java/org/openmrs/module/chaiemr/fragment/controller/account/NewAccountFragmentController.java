 ...
 */
package org.openmrs.module.chaiemr.fragment.controller.account;
...
import org.openmrs.module.chaiemr.metadata.SecurityMetadata;
import org.openmrs.module.chaiemr.validator.EmailAddressValidator;
...
public class NewAccountFragmentController {
	...
	public SimpleObject submit(@MethodParam("newCreateAccountForm") @BindParams CreateAccountForm form,
		...
		try {
			...
			chaiUi.notifySuccess(session, "Account created");
	...
	public class CreateAccountForm extends AbstractWebForm {
		...
		/**
		 * @see org.openmrs.module.chaiui.form.AbstractWebForm#validate(Object, org.springframework.validation.Errors)
		 */
		@Override
		public void validate(Object target, Errors errors) {
			...
			if (StringUtils.isNotEmpty(username)) {
				...
				if (Context.getUserService().getUserByUsername(username) != null) {
					errors.rejectValue("username", "chaiemr.error.username.taken");
				}
				...
				if (StringUtils.isEmpty(confirmPassword)) {
					...
					errors.rejectValue("confirmPassword", "chaiemr.error.confirmPassword.match");
				}
			...
			if (StringUtils.isNotEmpty(providerIdentifier)) {
				...
				if (withId != null) {
					errors.rejectValue("providerIdentifier", "chaiemr.error.providerIdentifier.taken");
				}
			}
