...
package org.openmrs.module.chaiemr.form.velocity;

import org.junit.Assert;
import org.junit.Before;
import org.junit.Test;
import org.openmrs.module.htmlformentry.FormEntrySession;
import org.openmrs.module.chaiemr.test.TestUiUtils;
...
public class UiVelocityFunctionsTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.chaiemr.form.velocity.UiVelocityFunctions#resourceLink(String, String)
	 */
	@Test
	public void resourceLink() {
		WebConstants.CONTEXT_PATH = "testing";

		Assert.assertThat(functions.resourceLink("chaiemr", "test.png"), is("/testing/ms/uiframework/resource/chaiemr/test.png"));
	}
}