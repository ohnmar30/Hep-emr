...
import org.openmrs.module.chaiemr.test.EmrTestUtils;
...
public class RegimenChangeHistoryTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.chaiemr.regimen.RegimenChangeHistory#RegimenChangeHistory(java.util.Set, java.util.List)
