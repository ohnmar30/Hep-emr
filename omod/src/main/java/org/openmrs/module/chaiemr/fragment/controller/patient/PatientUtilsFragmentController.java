...
import org.openmrs.module.chaiemr.fragment.controller.intake.EnterLabResultFragmentController;
...
public class PatientUtilsFragmentController {
	...
	private boolean getMsmConcept(){
		...
		//System.out.println("Total encounter size :"+encounter.getAllObs().size());
