...
public class EditPatientFormPageControllerTest extends BaseModuleWebContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.chaiemr.page.controller.EditProgramFormPageController#controller(String, org.openmrs.PatientProgram, String, String)
	 */
	@Test
	public void controller() {
		...
		Assert.assertThat(result, is("redirect:chaiemr/enterForm.page?formUuid=8e4e1abf-7c08-4ba8-b6d8-19a9f1ccb6c9&appId=test.app&patientId=7&returnUrl=test.html"));
		...
		String expected = "redirect:chaiemr/editForm.page?encounterId=" + encounter.getId() + "&appId=test.app&patientId=7&returnUrl=test.html";
