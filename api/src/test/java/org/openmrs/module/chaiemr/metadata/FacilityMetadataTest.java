...
public class FacilityMetadataTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.chaiemr.metadata.FacilityMetadata#install()
	 */
	@Test
	...
	public void install_shouldInstallAllMetadata() throws Exception {
		...
		Facility facility1 = new Facility(chaiEmrService.getLocationByMflCode("10001"));
		...
		Assert.assertThat(facility1.getCountry(), is("Chai"));
		...
		Facility facility2 = new Facility(chaiEmrService.getLocationByMflCode("10002"));
		...
		Assert.assertThat(facility2.getCountry(), is("Chai"));
