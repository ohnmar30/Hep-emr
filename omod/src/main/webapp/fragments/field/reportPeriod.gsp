...
Start Date 
${ ui.includeFragment("chaiui", "field/java.util.Date" ,[id:'startDate',  formFieldName:startFieldName, showTime: false])}
End Date 
${ ui.includeFragment("chaiui", "field/java.util.Date" ,[id:'endDate',  formFieldName:endFieldName, showTime: false])}
