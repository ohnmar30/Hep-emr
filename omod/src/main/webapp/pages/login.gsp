		...
		<table style="margin-left: auto; margin-right: auto; border: 0" cellpadding="3" cellspacing="0">
			<tr>
				<td style="padding-right: 15px">
					<!-- <img src="${ ui.resourceLink("chaiemr", "images/logos/moh.png") }" width="250" height="250"/> -->
				</td>
				<td style="padding-left: 15px; padding-top: 75px" valign="top">
					<table border="0" cellpadding="3" cellspacing="0">
						...
						<tr>
							<td></td>
							<td style="text-align: left"><button type="submit"><img src="${ ui.resourceLink("chaiui", "images/glyphs/login.png") }" /> Login</button></td>
						</tr>
						<tr>
							<td></td>
