...
<form method="post" action="${ ui.pageLink("chaiemr", "forgotPassword") }" style="padding: 20px; width: 500px">
	...
	<br />
	<button type="submit"><img src="${ ui.resourceLink("chaiui", "images/glyphs/secret.png") }" /> Show secret question</button>
	<button type="button" onclick="ui.navigate('login.htm')"><img src="${ ui.resourceLink("chaiui", "images/glyphs/cancel.png") }" /> Cancel</button>
	...
	<button type="submit"><img src="${ ui.resourceLink("chaiui", "images/glyphs/login.png") }" /> Submit secret answer</button>
