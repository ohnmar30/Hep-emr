...
<div class="ke-panel-content">
	...
	<script type="text/javascript">
		jQuery(function() {
			...
			chaiemr.fetchHelpResources(externalHelpUrl, currentAppId, function(resources) {
	...
	<div style="width:450px; margin:0 auto; text-align: center; background-color: #e8e7e2; padding: 10px; border-radius: 4px">
		<img src="${ ui.resourceLink("chaiui", "images/glyphs/phone.png") }" class="ke-glyph" /> Call the help desk for free at <strong>${ supportNumber }</strong><br />
		or<br />
		<img src="${ ui.resourceLink("chaiui", "images/glyphs/email.png") }" class="ke-glyph" /> Email <a href="mailto:${ supportEmail }">${ supportEmail }</a>
		<br />
		<br />
