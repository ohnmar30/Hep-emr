...
/**
 * Interceptor to catch requests to controllers outside of ChaiEMR and any add-on modules
 */
public class EmrExternalUrlInterceptor extends HandlerInterceptorAdapter {

	@Autowired
	protected ChaiUiUtils chaiUi;
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		if (!allowRequest) {
			...
			chaiUi.notifyError(request.getSession(), "Invalid external page access");
