<%
	...
	if (isToday)
		...
		heading += chaiui.formatDate(date)
%>

<div class="ke-panel-frame" ng-controller="DailySchedule" ng-init="init('${ currentApp.id }', '${ chaiui.formatDateParam(date) }', '${ config.pageProvider }', '${ config.page }')">
