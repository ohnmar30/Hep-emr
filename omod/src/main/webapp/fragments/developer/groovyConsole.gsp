<%
	ui.decorateWith("chaiui", "panel", [ heading: "Groovy Console", frameOnly: true ]);

	ui.includeJavascript("chaiemr", "codemirror.js");
	ui.includeJavascript("chaiemr", "codemirror-groovy.js");
	ui.includeCss("chaiemr", "codemirror.css");
