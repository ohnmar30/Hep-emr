 ...
 * Account service
 */
chaiemrApp.service('AccountService', function ($rootScope) {
 ...
 */
chaiemrApp.controller('AccountSearchForm', ['$scope', 'AccountService', function($scope, accountService) {
 ...
 */
chaiemrApp.controller('AccountSearchResults', ['$scope', '$http', function($scope, $http) {
	...
	$scope.refresh = function() {
		$http.get(ui.fragmentActionLink('chaiemr', 'search', 'accounts', { appId: $scope.appId, q: $scope.query, which: $scope.which })).
