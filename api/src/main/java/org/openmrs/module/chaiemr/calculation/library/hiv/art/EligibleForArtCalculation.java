...
import org.openmrs.module.chaiemr.calculation.library.hiv.LostToFollowUpIncludingTransferOutCalculation;
...
public class EligibleForArtCalculation extends AbstractPatientCalculation implements PatientFlagCalculation {
	...
	private boolean isFamilyHistoryRelationWith(Patient patient) {
		Concept relationshipConcept = Dictionary.getConcept(Dictionary.FAMILY_HISTORY_RELATIONSHIP);
		List<Obs> relationshipObs = Context.getObsService().getObservationsByPersonAndConcept(patient, relationshipConcept);
