...
/**
 * Tests for {@link ChaiEmrServiceImpl}
 */
public class ChaiEmrServiceImplTest extends BaseModuleContextSensitiveTest {
	...
	@Autowired
	private ChaiEmrService service;
	...
	/**
	 * @see org.openmrs.module.chaiemr.api.impl.ChaiEmrServiceImpl#getDefaultLocation()
	...
	/**
	 * @see org.openmrs.module.chaiemr.api.impl.ChaiEmrServiceImpl#getDefaultLocationMflCode()
	...
	/**
	 * @see org.openmrs.module.chaiemr.api.impl.ChaiEmrServiceImpl#getLocationByMflCode(String)
	...
	/**
	 * @see ChaiEmrServiceImpl#isSetupRequired()
	...
	/**
	 * @see ChaiEmrServiceImpl#setupMrnIdentifierSource(String)
	...
	/**
	 * @see ChaiEmrServiceImpl#setupHivUniqueIdentifierSource(String)
	 * @verifies fail if already set up
	 */
	@Test(expected = Exception.class)
	...
	/**
	 * @see ChaiEmrServiceImpl#getNextHivUniquePatientNumber(String)
	...
	public void getNextHivUniquePatientNumber_shouldGetSequentialNumbersWithMflPrefix() throws Exception {
		Location loc = Context.getLocationService().getLocation(1);
		Assert.assertNotNull(loc);
		Context.getService(ChaiEmrService.class).setDefaultLocation(loc);
	...
	/**
	 * @see org.openmrs.module.chaiemr.api.impl.ChaiEmrServiceImpl#getVisitsByPatientAndDay(org.openmrs.Patient, java.util.Date)
	 */
	@Test
