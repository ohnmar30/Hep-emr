...
def manager = contextSingleton("org.openmrs.module.chaicore.calculation.CalculationManager")
def flagClazz = Context.loadClass("org.openmrs.module.chaicore.calculation.PatientFlagCalculation")
