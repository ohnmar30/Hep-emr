...
<div class="ke-page-sidebar">
	${ ui.includeFragment("chaiemr", "patient/patientSearchForm2", [ defaultWhich: "all" ]) }

	${ ui.includeFragment("chaiui", "widget/panelMenu", [ heading: "Tasks", items: menuItems ]) }
</div>

<div class="ke-page-content">
	${ ui.includeFragment("chaiemr", "patient/patientSearchResults2", [ pageProvider: "chaiemr", page: "registration/registrationViewPatient" ]) }
</div>
