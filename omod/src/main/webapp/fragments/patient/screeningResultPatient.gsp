<%
	ui.decorateWith("chaiui", "panel", [ heading: (config.heading ?: "Screening Results"), frameOnly: true ])
...
<form id="screening-result-form" method="post" action="${ ui.actionLink("chaiemr", "patient/screeningRegisterPatient", "savePatient") }">
	<% if (command.original) { %>
	...
	<div class="ke-panel-content">
		...
		<fieldset>
			...
			<table>			
				<tr>	
					<td>HBsAg&nbsp;&nbsp;&nbsp;</td>
					<td><input type="checkbox" id="hBsAg" name="hBsAg" ${ command.hBsAg ? 'checked="checked"' : '' }></td>
					
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>Anti-HCV Ag&nbsp;&nbsp;&nbsp;</td>
					<td><input type="checkbox" id="antiHCV" name="antiHCV" ${ command.antiHCV == true ? 'checked="checked"' : '' }></td>
				</tr>
				<tr>
					
					<td><select id="hBsAgResult" name="hBsAgResult">
						<option value="703AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">Positive</option>
						<option value="664AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">Negative</option>
					</select></td>
					<td>&nbsp;&nbsp;&nbsp;</td>
					<td>&nbsp;&nbsp;&nbsp;</td>
					<td><select id="antiHCVResult" name="antiHCVResult">
						<option value="703AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">Positive</option>
						<option value="664AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">Negative</option>
					</select>
					</td>
...
jQuery(document).ready(function(){  
	...
	jQuery(function() {
		...
		chaiui.setupAjaxPost('screening-result-form', {
