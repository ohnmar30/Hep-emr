...
public class SystemUtilsFragmentController {
	 ...
	 * @param chaiUi the ChaiUI utils
	 * @return the information as a simple object
	 */
	@AppAction(EmrConstants.APP_ADMIN)
	public List<SimpleObject> getServerInformation(@SpringBean ChaiUiUtils chaiUi) {
		...
		memInfo.append(chaiUi.formatBytes(usedMemory));
		memInfo.append(" / ");
		memInfo.append(chaiUi.formatBytes(totalMemory));
		memInfo.append(" / ");
		memInfo.append(chaiUi.formatBytes(maxMemory));
