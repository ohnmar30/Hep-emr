...
package org.openmrs.module.chaiemr.regimen;
...
public class RegimenChangeHistory {
	 ...
	 *            the patient
	 * @param medSet
	 *            the medset concept defining the list of relevant drug concepts
	...
	public DrugOrderProcessed getLastDrugOrderProcessed(DrugOrder drugOrder) {
		...
		DrugOrderProcessed drugOrderProcessed = chaiEmrService.getLastDrugOrderProcessed(drugOrder);
		return drugOrderProcessed;
	}
