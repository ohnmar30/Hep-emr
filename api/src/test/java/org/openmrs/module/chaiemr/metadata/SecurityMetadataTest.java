...
public class SecurityMetadataTest extends BaseModuleContextSensitiveTest {
	...
	public void install_shouldInstallAllMetadata() {
		...
		Assert.assertThat(registration.hasPrivilege("App: chaiemr.registration"), is(true));
		Assert.assertThat(registration.hasPrivilege("App: chaiemr.directory"), is(true));
		Assert.assertThat(registration.hasPrivilege("App: chaiemr.facilities"), is(true));
		Assert.assertThat(registration.hasPrivilege("App: chaiemr.admin"), is(false));
	}
