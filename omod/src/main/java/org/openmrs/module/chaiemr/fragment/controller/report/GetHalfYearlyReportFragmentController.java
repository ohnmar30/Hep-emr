...
public class GetHalfYearlyReportFragmentController {
	...
	if(halfYearly!=null && halfYearly.equals("First Half")){
		...
		Set<Patient> cohortFor0_14AgeForFeb=chaiEmrService.getCohortBasedOnGender("F",febStartDate,febEndDate);
		Set<Patient> cohortFor0_14AgeForMarch=chaiEmrService.getCohortBasedOnGender("F",marchStartDate,marchEndDate);
		Set<Patient> cohortFor0_14AgeForApril=chaiEmrService.getCohortBasedOnGender("F",aprilStartDate,aprilEndDate);
		Set<Patient> cohortFor0_14AgeForMay=chaiEmrService.getCohortBasedOnGender("F",mayStartDate,mayEndDate);
		Set<Patient> cohortFor0_14AgeForJune=chaiEmrService.getCohortBasedOnGender("F",juneStartDate,juneEndDate);
		
		age1=15;
		age2=24;
		Set<Patient> cohortFor15_24AgeForJan=chaiEmrService.getCohortBasedOnAge(age1,age2,janStartDate, janEndDate);
		Set<Patient> cohortFor15_24AgeForFeb=chaiEmrService.getCohortBasedOnGender("F",febStartDate,febEndDate);
		Set<Patient> cohortFor15_24AgeForMarch=chaiEmrService.getCohortBasedOnGender("F",marchStartDate,marchEndDate);
		Set<Patient> cohortFor15_24AgeForApril=chaiEmrService.getCohortBasedOnGender("F",aprilStartDate,aprilEndDate);
		Set<Patient> cohortFor15_24AgeForMay=chaiEmrService.getCohortBasedOnGender("F",mayStartDate,mayEndDate);
		Set<Patient> cohortFor15_24AgeForJune=chaiEmrService.getCohortBasedOnGender("F",juneStartDate,juneEndDate);
		
		age1=25;
		age2=60;
		Set<Patient> cohortFor25_60AgeForJan=chaiEmrService.getCohortBasedOnAge(age1,age2,janStartDate, janEndDate);
		Set<Patient> cohortFor25_60AgeForFeb=chaiEmrService.getCohortBasedOnGender("F",febStartDate,febEndDate);
		Set<Patient> cohortFor25_60AgeForMarch=chaiEmrService.getCohortBasedOnGender("F",marchStartDate,marchEndDate);
		Set<Patient> cohortFor25_60AgeForApril=chaiEmrService.getCohortBasedOnGender("F",aprilStartDate,aprilEndDate);
		Set<Patient> cohortFor25_60AgeForMay=chaiEmrService.getCohortBasedOnGender("F",mayStartDate,mayEndDate);
		Set<Patient> cohortFor25_60AgeForJune=chaiEmrService.getCohortBasedOnGender("F",juneStartDate,juneEndDate);
	...
	if(halfYearly!=null && halfYearly.equals("Second Half")){
		...
		Set<Patient> noOfArtStoppedCohortForForDecember=chaiEmrService.getNoOfArtStoppedCohort(program,decemberStartDate,decemberEndDate);
