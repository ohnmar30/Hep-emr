...
import org.openmrs.module.chaiemr.util.BuildProperties;
...
public class PageHeaderFragmentControllerTest extends BaseModuleWebContextSensitiveTest {
	...
	/**
	 * @see PageHeaderFragmentController#controller(org.openmrs.ui.framework.fragment.FragmentModel, org.openmrs.module.chaiui.ChaiUiUtils)
	 */
	@Test
	public void controller_shouldInitializeModelForSnapshotVersions() {
		...
		controller.controller(model, chaiui);
