...
public class ProfileLoginDetailsFragmentController {
	...
	public class ChangePasswordForm extends ValidatingCommandObject {
		...
		public void validate(Object target, Errors errors) {
			...
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "oldPassword", "chaiemr.error.required");
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "newPassword", "chaiemr.error.required");
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "confirmNewPassword", "chaiemr.error.required");
			...
			if (!errors.hasErrors()) {
				if (form.getNewPassword().equals(form.getConfirmNewPassword())) {
					...
					errors.rejectValue("confirmNewPassword", "chaiemr.error.confirmPassword.match");
				}
			}
		}
	...
	public class ChangeSecretQuestionForm extends ValidatingCommandObject {
		...
		@Override
		public void validate(Object target, Errors errors) {
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "currentPassword", "chaiemr.error.required");
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "secretQuestion", "chaiemr.error.required");
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "newSecretAnswer", "chaiemr.error.required");
		}
