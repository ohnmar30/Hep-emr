...
package org.openmrs.module.chaiemr.reporting.builder.hiv;
...
import org.openmrs.module.chaiemr.calculation.library.hiv.art.AgeAtARTInitiationCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.CD4AtARTInitiationCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.CohortReportTypeCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.CurrentARTStartDateCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.CurrentArtRegimenCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.DateARV1Calculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.DateARV2Calculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.DateLastSeenCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.DateOfEnrollmentCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.FacilityNameCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.InitialArtRegimenCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.IsBirthDateApproximatedCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.IsTransferInCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.IsTransferOutCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.LastCd4Calculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.LastCd4CountDateCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.MflCodeCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.OriginalCohortCalculation;
import org.openmrs.module.chaiemr.calculation.library.hiv.art.PatientOutComeCalculation;
...
import org.openmrs.module.chaiemr.reporting.data.converter.BirthdateConverter;
import org.openmrs.module.chaiemr.reporting.data.converter.CalculationResultConverter;
...
@Component
@Builds({"chaiemr.hiv.report.artCohortAnalysis.6", "chaiemr.hiv.report.artCohortAnalysis.12", "chaiemr.hiv.report.artCohortAnalysis.24", "chaiemr.hiv.report.artCohortAnalysis.36"})
public class ArtCohortAnalysisReportBuilder extends AbstractHybridReportBuilder {
	...
	/**
	 *
	 * @see org.openmrs.module.chaicore.report.builder.AbstractCohortReportBuilder#getParameters(ReportDescriptor)
	 */
	@Override
	...
	/**
	 *
	 * @see org.openmrs.module.chaicore.report.builder.AbstractCohortReportBuilder#addColumns(CohortReportDescriptor, PatientDataSetDefinition)
	 */
	@Override
