...
public class HomePageController {
	...
	public String controller(PageModel model, UiUtils ui, HttpSession session, @SpringBean ChaiUiUtils chaiUi) {

		// Redirect to setup page if module is not yet configured
		if (Context.getService(ChaiEmrService.class).isSetupRequired()) {
			chaiUi.notifySuccess(session, "First-Time Setup Needed");
